...
player_structure = dict(
    ...
    buildings=[(b.STRING, b.INT)],  # Count of buildings does not appear to be accurate
    damage_dealt_cumulative=[(b.STRING, b.DOUBLE)],
    damage_taken_cumulative=[(b.STRING, b.DOUBLE)],
    bin5=b.DataFormat(8),  # Unknown purpose
    resources_cumulative=[(b.STRING, b.DOUBLE)],
    units_created_cumulative=[(b.STRING, b.INT)],
    units_killed_cumulative=[(b.STRING, b.INT)],
    units_lost_cumulative=[(b.STRING, b.INT)],
    name=b.STRING,
    faction=b.STRING,
    is_AI=b.BOOL,
    ...
    research=b.DOUBLE,
    research_unk1=[b.STRING],  # Frequently the same list as the one below
    research_unk2=[b.STRING],  # I believe this is research completed
    research_underway=[b.STRING],
